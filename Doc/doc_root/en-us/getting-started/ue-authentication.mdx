...
custom_edit_url: https://github.com/modio/modio-ue4-internal/blob/develop/Plugins/Modio/Doc/doc_root/en-us/getting-started/ue-authentication.mdx
---
...
- [Initialize](/unreal/initialization) the mod.io plugin with the required environment parameters for the current platform.
- Display the mod.io [Terms of Service](https://docs.mod.io/terms).  Ensure they are accepted by the user.
...
See our full [Terms & User Consent](https://docs.mod.io/terms) documentation for further details.
...
:::note[Premium Feature] Custom SSO & Platform Support is a premium feature. Please contact us at developers@mod.io for more information. :::
...
2. [**Platform SSO**](https://docs.mod.io/authentication/platform): Platform SSO uses a given platform's authentication process as the single point of authentication. 
	...
	* [Epic Games](https://docs.mod.io/platforms/epic/authentication)
	* itch.io
	* Discord
