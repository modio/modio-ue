...
public:
	...
	{
		Modio->GetTermsOfUseAsync(EModioAuthenticationProvider::Steam,EModioLanguage::English, FOnGetTermsOfUseDelegateFast::CreateSP(this, &FModioGetTermsOfUseAsyncCommand::Callback));
	}
