...
class FModioUnmuteUserAsyncCommand : public FModioTestLatentCommandBaseExpectedResult
{
	FModioModID ModID;

public:
	FModioUnmuteUserAsyncCommand(FAutomationTestBase* AssociatedTest, EModioErrorCondition ExpectedResult)
	...
	{
		// Modio->GetTermsOfUseAsync(EModioAuthenticationProvider::Steam,EModioLanguage::English,
		// FOnGetTermsOfUseDelegateFast::CreateSP(this, &FModioUnmuteUserAsyncCommand::Callback));
	}
