		...
		if (UModioSubsystem* Subsystem = GEngine->GetEngineSubsystem<UModioSubsystem>())
		{
			...
			Subsystem->GetTermsOfUseAsync(CurrentLanguage, FOnGetTermsOfUseDelegateFast::CreateWeakLambda(this, [this](FModioErrorCode ErrorCode, TOptional<FModioTerms> Terms) {
				...
				if (EmailAuthViewClass)
				{
					...
					EmailAuthView->OnBackClicked.BindUObject(this, &UModioCommonAuthView::OnEmailAuthViewBackClicked);
					EmailAuthView->OnCancelClicked.BindUObject(this, &UModioCommonAuthView::OnEmailAuthViewCancelClicked);
					EmailAuthView->OnSubmitClicked.BindUObject(this, &UModioCommonAuthView::OnEmailAuthViewSubmitClicked);
				...
				if (EmailAuthLoadingViewClass)
				{
					...
					EmailAuthLoadingView->OnCancelClicked.BindUObject(this, &UModioCommonAuthView::OnEmailAuthLoadingViewCancelClicked);
				...
				if (EmailAuthCodeViewBaseClass)
				{
					...
					EmailAuthCodeView->OnBackClicked.BindUObject(this, &UModioCommonAuthView::OnEmailAuthCodeViewBackClicked);
					EmailAuthCodeView->OnCancelClicked.BindUObject(this, &UModioCommonAuthView::OnEmailAuthCodeViewCancelClicked);
					EmailAuthCodeView->OnSubmitClicked.BindUObject(this, &UModioCommonAuthView::OnEmailAuthCodeViewSubmitClicked);
