...
/**
 * @brief Auth View that displays the terms of use, email auth, email auth loading and email auth code views, with automatic switching between them
 */
UCLASS(Abstract, Blueprintable, ClassGroup = "UI", meta = (Category = "Mod.io Common UI"))
class MODIOUI5_API UModioCommonAuthView : public UModioCommonAuthViewBase
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY(BlueprintReadOnly, EditAnywhere, Category = "Mod.io Common UI|Auth View")
	EModioAuthenticationProvider AuthenticationProvider;
