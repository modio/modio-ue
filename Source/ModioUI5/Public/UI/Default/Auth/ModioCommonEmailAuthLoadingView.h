...
/**
 * @brief Email Auth Loading View that displays a loading state while the email auth process is ongoing
 */
UCLASS(Abstract, Blueprintable, ClassGroup = "UI", meta = (Category = "Mod.io Common UI"))
class MODIOUI5_API UModioCommonEmailAuthLoadingView : public UModioCommonEmailAuthLoadingViewBase
{
	GENERATED_BODY()
