...
/**
 * @brief Email Auth View that displays a form for the user to enter their email address to begin the email auth process
 */
UCLASS(Abstract, Blueprintable, ClassGroup = "UI", meta = (Category = "Mod.io Common UI"))
class MODIOUI5_API UModioCommonEmailAuthView : public UModioCommonEmailAuthViewBase
{
	GENERATED_BODY()
