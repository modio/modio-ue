...
/**
 * @brief Terms Of Use View that displays the terms of use and allows the user to accept or reject them
 */
UCLASS(Abstract, Blueprintable, ClassGroup = "UI", meta = (Category = "Mod.io Common UI"))
class MODIOUI5_API UModioCommonTermsOfUseView : public UModioCommonTermsOfUseViewBase
{
	GENERATED_BODY()
