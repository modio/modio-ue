...
class MODIOUI5_API UModioCommonModGalleryItem : public UObject
{
	GENERATED_BODY()
...
/**
 * @brief Mod Gallery Entry that displays a mod image to be used in a Mod Gallery View
 * It supports styling through the Mod.io Common UI styling system
 */
UCLASS(Abstract, Blueprintable, ClassGroup = "UI", meta = (Category = "Mod.io Common UI"))
class MODIOUI5_API UModioCommonModGalleryEntry : public UModioCommonActivatableWidget, public IUserObjectListEntry
{
	GENERATED_BODY()
