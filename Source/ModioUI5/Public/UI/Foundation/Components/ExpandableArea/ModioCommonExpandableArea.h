...
/**
 * @brief Expandable area widget that allows to customize the style
 */
UCLASS(ClassGroup = "UI", meta = (Category = "Mod.io Common UI"))
class MODIOUI5_API UModioCommonExpandableArea : public UExpandableArea
{
	GENERATED_BODY()

public:
	/**
	 * @brief Set the style of the Expandable Area within the Mod.io Common UI styling system
...
protected:
	/** @brief The style of the Expandable Area within the Mod.io Common UI styling system */
...
public:
	/**
	 * @brief Handle the focus received event
	 */
...
protected:
	...
	/**
	 * @brief Get the attached label text block
	...
	/**
	 * @brief Refresh the content of the expandable area. This forces the widget to be rebuilt and reapply the style
	 * @return The new content of the expandable area
	 */
	virtual TSharedRef<SWidget> RefreshContent();

	/**
	 * @brief Refresh the style of the expandable area
	 */
