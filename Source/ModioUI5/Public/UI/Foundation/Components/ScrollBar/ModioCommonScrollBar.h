...
/**
 * @brief Scroll Bar that can be used in Mod.io UI
 * It supports styling through the Mod.io Common UI styling system
 */
UCLASS(ClassGroup = "UI", meta = (Category = "Mod.io Common UI"))
class MODIOUI5_API UModioCommonScrollBar : public UScrollBar
{
	GENERATED_BODY()
public:
	/**
	 * @brief Sets the style of the Scroll Bar within the Mod.io Common UI styling system
