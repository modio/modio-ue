...
/**
 * @brief Mod Tag Entry that represents a single mod tag entry
 */
UCLASS(Abstract, Blueprintable, ClassGroup = "UI", meta = (Category = "Mod.io Common UI"))
class MODIOUI5_API UModioCommonModTagEntry : public UModioCommonActivatableWidget
{
	GENERATED_BODY()
...
public:
	/**
	 * @brief Sets the tag for this entry to the specified tag
	...
	/**
	 * @brief Gets the tag for this entry
	...
	/**
	 * @brief Sets whether this tag entry allows multiple selection
	...
	/**
	 * @brief Gets whether this tag entry allows multiple selection
	...
	/**
	 * @brief Sets whether this tag entry is selected
	...
	/**
	 * @brief Gets whether this tag entry is selected
